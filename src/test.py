...
doc ="""Năm trung tâm đăng kiểm ở Hà Nội được mở cửa trở lại từ sáng 13/3 sau thời gian tạm đóng, nâng tổng số đơn vị hoạt động lên 13.
...
# Calculate TF with custom weighting scheme
tf = {}
